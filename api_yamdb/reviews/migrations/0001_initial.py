# Generated by Django 3.2 on 2023-08-03 21:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=256, verbose_name='Название')),
                ('year', models.PositiveSmallIntegerField(db_index=True, validators=[django.core.validators.MaxValueValidator(reviews.models.get_current_year)], verbose_name='Год создания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Нельзя поставить оценку ниже 1.'), django.core.validators.MaxValueValidator(10, message='Нельзя поставить оценку выше 10.')], verbose_name='Оценка')),
